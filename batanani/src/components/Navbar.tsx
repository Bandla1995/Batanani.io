...
import { BotMessageSquare, CalendarIcon, CrownIcon, HomeIcon, MicIcon } from "lucide-react";
      ...
      <div className="max-w-7xl mx-auto flex justify-between items-center h-full">
        ...
        <div className="flex items-center gap-8">
          <Link href="/dashboard" className="flex items-center gap-2">
            <Image src="/logo.png" alt="Bata Logo" width={32} height={32} className="w-11" />
          </Link>
          ...
          <div className="flex items-center gap-6">
            ...
            >
              ...
              <span className="hidden md:inline">Lets talk</span>
            </Link>
