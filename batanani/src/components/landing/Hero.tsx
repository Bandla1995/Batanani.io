...
import { BotMessageSquare, CalendarIcon, MicIcon, StarIcon } from "lucide-react";
            ...
            <div className="space-y-10">
              <div className="space-y-6">
                ...
                <div className="inline-flex items-center gap-2 px-4 py-2 bg-gradient-to-r from-primary/10 to-primary/5 rounded-full border border-primary/20 backdrop-blur-sm">
                  ...
                  <span className="text-sm font-medium text-primary">
                    AI-Powered Hair dresser Assistant
                  </span>
                </div>
                ...
                <p className="text-lg text-muted-foreground leading-relaxed max-w-xl font-medium">
                  Chat with our AI hair dresser assistant for instant advice, book smart appointments, and
                  get personalized hair style recommendations. Available from 9 to 8.
                </p>
              </div>
              ...
              <div className="flex flex-col sm:flex-row gap-4">
                ...
                <SignUpButton mode="modal">
                  ...
                  <Button size={"lg"} variant={"outline"}>
                    <BotMessageSquare  className="mr-2 size-7" />
                    Try AI chatbox
                  </Button>
                </SignUpButton>
                ...
                <div className="flex items-center gap-6">
                  ...
                  <div className="space-y-1">
                    ...
                    <p className="text-sm text-muted-foreground">
                      Trusted by{" "}
                      <span className="font-semibold text-foreground">100+ customers</span>
                    </p>
                  </div>
                </div>
              </div>
