    ...
    <div className="grid md:grid-cols-2 gap-8 mb-12">
      ...
      <Card className="relative overflow-hidden group hover:shadow-xl transition-all duration-300 border-2 hover:border-primary/30">
        ...
        <CardContent className="relative space-y-4">
          ...
          <div className="flex items-start gap-3">
            <div className="w-2 h-2 bg-primary rounded-full mt-2"></div>
            <span className="text-sm">Ask questions about which hair style you want and your location</span>
          </div>
          <div className="flex items-start gap-3">
            <div className="w-2 h-2 bg-primary rounded-full mt-2"></div>
      ...
      <Card className="relative overflow-hidden group hover:shadow-xl transition-all duration-300 border-2 hover:border-primary/30">
        ...
        <CardHeader className="relative">
          ...
          <CardDescription>Advanced capabilities for hair styles needed </CardDescription>
        </CardHeader>
        <CardContent className="relative space-y-4">
